...
const MultimodalSearch: React.FC<MultimodalSearchProps> = ({ onSearch }) => {
  ...
  const processImageWithGroq = async (file: File) => {
    ...
    try {
      ...
      // Use AI to determine search filters from the extracted content
      const filters = await processNaturalLanguageQuery(result.extractedText);
      ...
      <form onSubmit={handleTextSearch} className="relative">
        ...
        {imagePreview && (
          <div className="mt-2 relative">
            <div className="relative border border-gray-300 rounded-lg overflow-hidden h-32 w-full">
